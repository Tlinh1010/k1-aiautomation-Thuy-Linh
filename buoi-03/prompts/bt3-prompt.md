...
```text
BỐI CẢNH:
Đây là LỚP 3 trong hệ thống HR Screening 4 lớp cho vị trí R&D Ứng dụng AI (Junior/Fresher). Mục tiêu là áp rubric cố định, không tự thay trọng số và không tự quyết định tuyển dụng.

INPUT:
- candidate-profile.json từ TH1.
- data-quality.json từ TH2.
- templates/JD-RD-AI-ung-dung.md.
- templates/rubric-RD-AI-100.json.
