...
```text
BỐI CẢNH:
Tôi đang xây hệ thống HR Screening 4 lớp cho vị trí R&D Ứng dụng AI (Junior/Fresher).
...
candidate-profile.json phải là JSON hợp lệ gồm:
{
  ...
  "candidate_name": "",
  "full_time": null,
  "months_ai_experience": 0,
  "ai_tools_used": [],
  "prompt_engineering_evidence": "",
  "testing_validation_evidence": "",
  "self_learning_evidence": [],
  "communication_evidence": "",
  "structured_thinking_evidence": "",
  "english_reading_evidence": "",
  "technical_tools": [],
  "evidence_summary": "",
  "evidence": {}
}
